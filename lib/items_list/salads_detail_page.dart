...
class SaladsDetailPage extends StatelessWidget {
  final String name;
  final String image;
  final int price;
  final String description;

  const SaladsDetailPage({
    super.key,
    required this.name,
    required this.image,
    required this.price,
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        /* INFO ROW (SALAD SPECIFIC) */
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: const [
                            _InfoTile(Icons.eco, "Healthy"),
                            _InfoTile(Icons.timer, "5 mins"),
                            _InfoTile(Icons.local_fire_department, "90 kcal"),
                          ],
                        ),
                      ],
                    ),
