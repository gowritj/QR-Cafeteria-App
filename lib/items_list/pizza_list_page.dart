...
import 'package:module/items_list/pizza_detail_page.dart';
...
class _PizzaListPageState extends State<PizzaListPage> {
  ...
  final List<Map<String, dynamic>> pizzas = [
    ...
    },
    {
      ...
      "price": 249,
      "image": "assets/images/pizza_farmhouse.jpg",
      "description":
          "Loaded with veggies, cheese, and rich tomato sauce.",
    },
    {
      ...
      "description":
          "Crispy pepperoni with melted cheese on a thin crust.",
    },
    {
      "name": "Cheese Burst Pizza",
      "price": 279,
      "image": "assets/images/pizza_cheese_burst.jpg",
      "description":
          "Extra cheesy pizza with molten cheese inside the crust.",
    },
  ];
        ...
        builder: (context, snapshot) {
          ...
          return ListView(
            ...
            children: [
              ...
              // STATIC ITEMS
              ...pizzas.map((item) => productCard(item, false)),
